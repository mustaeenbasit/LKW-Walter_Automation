...
public class Studio_25729  extends SugarTest {
	 ...
	 *  
	 *  This method is for fetching URL with focus in bwc-frame
	 */
	@Test
	public void Studio_25729_bwc_execute() throws Exception {
		...
		// TODO: Investigate why this Assert is failing
		// java.lang.AssertionError: Error verifying: Browser back from Search page to Quick create. 
		// Current: http://localhost:8080/SugarEnt-7.7.0.0/index.php?module=ModuleBuilder&action=index&type=studio#mbContent=module%3DModuleBuilder%26action%3Dwizard%26view%3Dlayouts%26view_module%3DContracts 
		//    Back: http://localhost:8080/SugarEnt-7.7.0.0/index.php?module=ModuleBuilder&action=index&type=studio#mbContent=module%3DModuleBuilder%26action%3DeditLayout%26view%3Dquickcreate%26view_module%3DContracts
