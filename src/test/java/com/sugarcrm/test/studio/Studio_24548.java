...
public class Studio_24548 extends SugarTest {
	...
	public void setup() throws Exception {
		...
		// Adding multiple custom fields, formula add on currency field (i.e add(floor(int), floor(float), floor(decimal)))
	...
	/**
	 * Check calculation with floor function in the formula of calculated field
	 * @throws Exception
	 */
	@Test
	public void Studio_24548_execute() throws Exception {
