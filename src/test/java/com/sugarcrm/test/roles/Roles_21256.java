...
public class Roles_21256 extends SugarTest {
	FieldSet roleRecord;

	public void setup() throws Exception {
		roleRecord = testData.get("Roles_21256").get(0);
		sugar().login();
	}

	/**
	 * Verify user should have the developer studio privilege while the access
	 * type is set to developer
	 * 
	 * @throws Exception
	 */
	@Test
	...
	public void Roles_21256_execute() throws Exception {
