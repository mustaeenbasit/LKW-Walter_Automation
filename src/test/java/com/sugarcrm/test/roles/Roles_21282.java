...
public class Roles_21282 extends SugarTest {
	...
	/**
	 * Field permissions set to "Read Only" on Accounts (group field) - Verify inline edit and editview "write"
	 * @throws Exception
	 */
	@Test
	public void Roles_21282_execute() throws Exception {
		...
		// Verify fields of the billing address is read only, inline Edit.
		...
		// Verify no pencil icon appears on hover. 
		pencilIconCtrl.assertVisible(false);

		// Verify that all fields of the billing address is read only, Edit view.
