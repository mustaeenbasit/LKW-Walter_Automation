...
public class Roles_21283 extends SugarTest {
	...
	/**
	 * Field permissions set to "Read Only" on Accounts (group field) - Verify report view of owned and non-owned records
	 * @throws Exception
	 */
	@Test
	public void Roles_21283_execute() throws Exception {
		...
		// Verify that all fields of the billing address is not Editable(Read-only), inline Edit
		...
		// Verify fields of the billing address is non editable(Read Only), pencil icon is not visible.
		billingAddressDetailCtrl.hover();
		pencilIconCtrl.assertVisible(false);
