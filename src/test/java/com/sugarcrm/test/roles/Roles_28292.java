...
public class Roles_28292 extends SugarTest {
	FieldSet customData;
	...
	public void setup() throws Exception {
		...
		// Edit Visibility to make 3 values available under Type = Prospect, such as Email, Web, and Mail
		new VoodooControl("button", "css", "#visGridRow > td:nth-child(2) > button").click();
		VoodooUtils.waitForReady();
		new VoodooControl("li", "css", "li[val='Mail']").dragNDrop(new VoodooControl("ul", "id", "ddd_Prospect_list"));
		new VoodooControl("li", "css", "li[val='Email']").dragNDrop(new VoodooControl("ul", "id", "ddd_Prospect_list"));
		new VoodooControl("li", "css", "li[val='Web']").dragNDrop(new VoodooControl("ul", "id", "ddd_Prospect_list"));
	...
	/**
	 * Verify that child multiSelect field appears correct with pareent LOV
	 *  
	 * @throws Exception
	 */
	@Test
	public void Roles_28292_execute() throws Exception {
		...
		type.set(customData.get("prospect"));
		VoodooUtils.waitForReady();
		
		// Verify that custom multipleSelect appears
