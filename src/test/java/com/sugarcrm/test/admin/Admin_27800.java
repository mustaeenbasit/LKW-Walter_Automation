...
public class Admin_27800 extends SugarTest {
	FieldSet fsData;
	
	public void setup() throws Exception {
		// switch to OpportunitiesView
	...
	/**
	 *  Verify that an alert informs user that all Forecast data will be reset when I change tracking from Opps only to Opps + RLIs
	 * 
	 * @throws Exception
	 */
	@Test
	public void Admin_27800_execute() throws Exception {
		...
		new VoodooControl("input", "css", "[name='opps_view_by'][value='RevenueLineItems']").click();
