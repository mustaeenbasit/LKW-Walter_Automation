...
public class Subpanels_17570 extends SugarTest {
	CaseRecord myCase;
	...
	/**
	 * Verify subpanel predefined filters - My Cases
	 * 
	 * @throws Exception
	 */
	@Test
	public void Subpanels_17570_execute() throws Exception {
		...
		// Click on Filter drop down and select "My cases" from predefined filter list
		// TODO: VOOD-1296
		filterFilterDropdown = new VoodooSelect("a", "css", "span[data-voodoo-name='filter-filter-dropdown'] div a");
		filterFilterDropdown.set("My "+sugar.cases.moduleNamePlural);
		sugar.alerts.waitForLoadingExpiration();

		// Verify, 'My Cases' should be shown next to Filter drop down after being selected
		new VoodooControl("span", "css", ".choice-filter .choice-filter-label").assertContains("My "+sugar.cases.moduleNamePlural, true);
