...
public class Teams_26084_contracts extends SugarTest {
	...
	/**
	 * Verify that for BWC modules - Create record works correctly when only one team is selected
	 * 
	 * @throws Exception 
	 */
	@Test
	public void Teams_26084_contracts_execute() throws Exception {
