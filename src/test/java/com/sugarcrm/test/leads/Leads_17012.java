...
public class Leads_17012 extends SugarTest {
	...
	/**
	 * Verify only Last Name and First Name matching result into dup check in Lead
	 * @throws Exception
	 */
	@Test
	public void Leads_17012_execute() throws Exception {
		VoodooUtils.voodoo.log.info("Running" + testName + "...");

		// Go to the Leads module
		sugar().leads.navToListView();

		// Create a new lead record with last name as Tim, enter "josh" in first name, rest fields leave blank.
		sugar().leads.listView.create();
		sugar().leads.createDrawer.setFields(leadsNames.get(0));
		sugar().leads.createDrawer.save();

		// Create 2nd new lead record with last name as Tim, enter "Josh" in first name, rest fields leave blank.
		sugar().leads.listView.create();
		...
		// TODO: VOOD-513
		new VoodooControl("span", "css", "div[data-voodoo-name='dupecheck-list-edit'] table tbody tr span.fld_full_name")
		.assertContains(leadsNames.get(0).get("firstName")+" "+leadsNames.get(0).get("lastName"), true);
