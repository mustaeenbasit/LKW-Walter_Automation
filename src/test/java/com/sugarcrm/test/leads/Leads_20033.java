...
public class Leads_20033 extends SugarTest {
	 ...
	 */
	@Test
	public void Leads_20033_execute() throws Exception {
		...
		sugar().leads.recordView.getDetailField("relAssignedTo").hover();
		...
		VoodooControl assignedToEditCtrl = sugar().leads.recordView.getEditField("relAssignedTo");
