...
public class ProcessAuthor_30678 extends SugarTest {
	...
	/**
	 * Verify Self service is working properly for BWC modules (Module = "Contract")
	 * @throws Exception
	 */
	@Test
	public void ProcessAuthor_30678_execute() throws Exception {
		...
		// Create a Contract to trigger the process
		...
		// Extra focus frame is required because after click event the page refreshes and the focus loses
		VoodooUtils.focusFrame("bwc-frame");

		// Assert that Claim button is visible on the page
		// TODO: VOOD-1933 - Need Lib support for "Claim" process record view
		new VoodooControl("a", "css", "#EditView a[title='Claim']").assertEquals(processInfo.get("claimButton"), true);
