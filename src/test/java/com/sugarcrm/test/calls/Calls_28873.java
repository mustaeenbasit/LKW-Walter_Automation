 ...
 */
public class Calls_28873 extends SugarTest {
	...
	/**
	 * Verify that label should not be missing for calls within a newly created role.
	 *  
	 * @throws Exception
	 */
	@Test
	public void Calls_28873_execute() throws Exception {
		...
		// TODO: VOOD-856
		new VoodooControl("a", "css", ".edit tr:nth-child(4) a").click();
