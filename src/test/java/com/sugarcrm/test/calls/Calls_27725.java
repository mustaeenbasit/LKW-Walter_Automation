...
public class Calls_27725 extends SugarTest {
	CallRecord myCall;
	...
	public void setup() throws Exception {
		...
		myCall = (CallRecord) sugar().calls.create(fs);
	}

	/**
	 * Verify Start Date has no background color if Start Date is passed 24 hours in Calls listview
	 * 
	 * @throws Exception 
	 */
	@Test
	public void Calls_27725_execute() throws Exception {
		...
		sugar().calls.recordView.getEditField("date_start_date").set(sugar().calls.getDefaultData().get("date_start_date"));
		sugar().calls.recordView.getEditField("date_end_date").set(sugar().calls.getDefaultData().get("date_end_date"));
