...
public class Calls_27809 extends SugarTest {
	...
	/**
	 * Verify that Reminder fields are consistent in list view and record view in Calls
	 * 
	 * @throws Exception
	 */
	@Test
	public void Calls_27809_execute() throws Exception {
		VoodooUtils.voodoo.log.info("Running " + testName + "...");

		// Go to Admin > Studio > Calls > Layouts 
