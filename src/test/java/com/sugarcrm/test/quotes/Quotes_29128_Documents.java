...
public class Quotes_29128_Documents extends SugarTest {
	...
	@Test
	public void Quotes_29128_Documents_execute() throws Exception {
		VoodooUtils.voodoo.log.info("Running " + testName + " for Documents module...");

		// Go to Documents module
		sugar.documents.navToListView();

		// Select View Documents from Documents module drop-down
		sugar.navbar.selectMenuItem(sugar.documents, "viewDocuments");

		// Click on Advanced Search
		VoodooUtils.focusFrame("bwc-frame");
		sugar.documents.listView.getControl("advancedSearchLink").click();
		...
		VoodooUtils.voodoo.log.info(testName + " for Documents module is complete.");
	}
