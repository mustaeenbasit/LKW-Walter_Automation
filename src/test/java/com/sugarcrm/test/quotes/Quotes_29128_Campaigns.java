...
public class Quotes_29128_Campaigns extends SugarTest {
	...
	@Test
	public void Quotes_29128_Campaigns_execute() throws Exception {
		VoodooUtils.voodoo.log.info("Running " + testName + " for Campaigns module...");

		// Go to Campaigns module
		sugar.campaigns.navToListView();

		// Select View Campaigns from Campaigns module drop-down
		sugar.navbar.selectMenuItem(sugar.campaigns, "viewCampaigns");
		...
		VoodooUtils.voodoo.log.info(testName + " for Campaigns module is complete.");
	}
