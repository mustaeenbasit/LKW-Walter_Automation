...
public class PasswordManagement_20000 extends SugarTest {
	...
	/**
	 * [Password Rules]-Selected"Must contain one upper case letter (A-Z)","Must contain one lower case letter (a-z)"and"Must contain one of the following special characters",
	 * Verify user according with the rules set password and login as successful
	 * 
	 * @throws Exception
	 */
	@Test
	public void PasswordManagement_20000_execute() throws Exception {
		...
		sugar().admin.passwordManagement.getControl("passwordSettingOneNumber").set(String.valueOf(false));
