...
/**
 * This test verifies that the User account is locked after 2 failed login attempts
 * 
 */
public class adminLoginAttempts extends SugarTestApi {
	...
	public void main() throws JSONException, ParseException,
		...
		myUtils.standardTestDriver("rest/base/adminLoginAttempts.json",
				UserTokensArray, recordIDs);
