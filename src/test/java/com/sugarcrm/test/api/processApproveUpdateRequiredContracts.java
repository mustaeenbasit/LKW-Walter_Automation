 ...
 * Static User to a Contracts Update event is verified with Required fields
 * 
 */
public class processApproveUpdateRequiredContracts extends SugarTestApi {
	...
	public void main() throws JSONException, ParseException,
		...
		myUtils.standardTestDriver(
				"rest/base/processApproveUpdateRequiredContracts.json",
				UserTokensArray, recordIDs);
	...
	public void cleanup() throws JSONException, ParseException,
		...
		jsonObject = myUtils
				.getJson("rest/base/processApproveUpdateRequiredContracts.json");
