 ...
 * KBContents Revisions
 * 
 */
public class KBContentsRevisionDelete extends SugarTestApi
{
         ...
         FileNotFoundException, IOException, ParseException
   {
      ...
      myUtils.standardTestDriver("rest/base/kbContentsRevisionDelete.json",
            UserTokensArray);
         ...
         FileNotFoundException, IOException
   {
      ...
      myUtils.deleteModules("rest/base/kbContentsRevisionDelete.json",
            UserTokensArray);
   }
