...
/**
* This test verifies that for a non-manager: When the Revenue Line Items are enabled and
* the middle manager updates the Forecast RLI adjusted likely amount for an individual's (direct report) RLI then the RLI adjusted likely amount
* is NOT changed if the individual subsequently updates the RLI likely amount
* 
*/
public class forecastsEditRLIAdjustDirectReport extends SugarTestApi {
   ...
   public void setup() throws FileNotFoundException, IOException,
	...
	public void main() throws JSONException, ParseException,
		...
		// Calls a standard loop to process the basic roll up rli s as a
		// prerequisite
		...
		myUtils.standardTestDriver(
				"rest/base/forecastsEditRLIAdjustDirectReport.json",
				UserTokensArray, recordIDs);
