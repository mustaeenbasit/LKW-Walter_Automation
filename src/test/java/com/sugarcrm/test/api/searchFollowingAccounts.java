...
public class searchFollowingAccounts extends SugarTestApi {
	...
	@Test
	/**
	 * Test Case searchFollowingAccounts: Verifies that a Followed Account is correctly returned using search for my items
	 * For Test Case 27209 - For 7.6 
	...
	public void main() throws JSONException, ParseException,
		...
		myUtils.standardTestDriver("searchFollowingAccounts.json",
				UserTokensArray);
	...
	public void cleanup() throws JSONException, ParseException,
		...
		jsonObject = myUtils.getJson("searchFollowingAccounts.json");
