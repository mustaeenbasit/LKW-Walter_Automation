...
/**
 * This is a basic smoke test to verify the retrieval of DnB Contacts
 * 
 */
public class adminDnBGetCompetitors extends SugarTestApi {
	...
	public void main() throws JSONException, ParseException,
		...
		myUtils.standardTestDriver("rest/base/adminDnBGetCompetitors.json",
				UserTokensArray, recordIDs);
