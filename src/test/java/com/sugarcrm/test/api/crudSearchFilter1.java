...
/**
 * This is a test for CRUD a basic Search Filter with filter id
 * 
 */
public class crudSearchFilter1 extends SugarTestApi
{
         ...
         FileNotFoundException, IOException, ParseException
   {
      ...
      myUtils.standardTestDriver("rest/base/crudSearchFilter1.json",
   ...
   // Delete all records that were created in this test via record ids
      myUtils.deleteModules("rest/base/crudSearchFilter1.json",
            UserTokensArray);
   }
