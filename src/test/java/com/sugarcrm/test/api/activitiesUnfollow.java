...
/**
 * This is a basic test for the reading Activities for Create and Update
 * Accounts, Contacts and Opportunities and then Un-following these records and
 * verifying no Activity records are created
 * 
 */
public class activitiesUnfollow extends SugarTestApi {
   ...
   public void setup() throws FileNotFoundException, IOException,
	...
	public void main() throws JSONException, ParseException,
		...
		// Calls a standard loop to process the prerequisites then the part 1
		// tests
		myUtils.standardTestDriver("rest/base/activitiesSmokeTest.json",
				UserTokensArray, recordIDs);
		myUtils.standardTestDriver("rest/base/activitiesUnfollow.json",
				UserTokensArray, recordIDs);
   ...
   public void cleanup() throws JSONException, ParseException,
		...
		myUtils.deleteModules("rest/base/activitiesUnfollow.json", UserTokensArray);
	}
