 ...
 * Static User to a multiple Contracts Creation event is verified
 * 
 */
public class processUserApproveMultipleRecordsBWC extends SugarTestApi {
   ...
   public void cleanup() throws JSONException, ParseException,
		...
		jsonObject = myUtils
				.getJson("rest/base/processUserApproveMultipleRecordsBWC.json");
