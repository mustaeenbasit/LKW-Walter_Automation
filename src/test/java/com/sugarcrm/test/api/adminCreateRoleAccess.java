...
/**
 * This is a basic smoke test to Create a Role and Access from a JSON data file
 * 
 */
public class adminCreateRoleAccess extends SugarTestApi {
   ...
   public void setup() throws FileNotFoundException, IOException,
	...
	public void main() throws JSONException, ParseException,
		...
		myRolesModule.CreateRole(adminUserID,
				"rest/base/adminCreateRoleAccess.json");

		// Verify the Standard Role has been created using REST API
		myUtils.standardTestDriver(
				"rest/base/adminCreateRoleAccessVerify.json", UserTokensArray,
				recordIDs);
