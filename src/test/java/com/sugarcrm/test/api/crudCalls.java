...
/**
 * This is a basic smoke test for the Creation, Read, Update and Delete of Calls
 * 
 */
public class crudCalls extends SugarTestApi {
	...
	public void main() throws JSONException, ParseException,
		...
		myUtils.standardTestDriver("rest/base/crudCalls.json", UserTokensArray);
	...
	public void cleanup() throws JSONException, ParseException,
		...
		jsonObject = myUtils.getJson("rest/base/crudCalls.json");
