...
/**
 * This test verifies the Creation of a Call that uses the Collections api
 * format to include related Contacts, Users and Leads
 * 
 */
public class callsCreateCollection extends SugarTestApi {
	...
	public void cleanup() throws JSONException, ParseException,
		...
		myUtils.deleteModules("rest/base/callsCreateCollection.json",
				UserTokensArray);
	}
