...
/**
 * This is a test for Process create and execution, the Assign and Rejection of a
 * Static User to an Account Update event is verified
 * 
 */
public class processUserRejectUpdateAccounts extends SugarTestApi {
	...
	public void main() throws JSONException, ParseException,
		...
		myUtils.standardTestDriver("rest/base/processUserRejectUpdateAccounts.json",
				UserTokensArray, recordIDs);
	...
	public void cleanup() throws JSONException, ParseException,
		...
		jsonObject = myUtils.getJson("rest/base/processUserRejectUpdateAccounts.json");
