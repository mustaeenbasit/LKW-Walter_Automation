...
public class globalSearchPart4 extends SugarTestApi {
	...
	public void setup() throws FileNotFoundException, IOException,
		...
		//Create 24 Accounts and Cases to perform searches on
		int x = 1;
		while (x < 25) {
			// Calls a standard loop to process the common json test driven
			// format
			myUtils.standardTestDriver("globalSearchPart4SetUp.json",
					UserTokensArray);
			x++;
		}
	}
	@Test
	/**
	 * Verifies the global search with module_filter 
	 * 
	...
	public void main() throws JSONException, ParseException,
		...
		myUtils.standardTestDriver("globalSearchPart4.json", UserTokensArray);
	...
	public void cleanup() throws JSONException, ParseException,
		...
		jsonObject = myUtils.getJson("globalSearchPart4.json");
