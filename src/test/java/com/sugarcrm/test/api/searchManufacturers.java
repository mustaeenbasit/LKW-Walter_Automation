...
public class searchManufacturers extends SugarTestApi {
	...
	@Test
	/**
	 * Test Case crudBugs: Verifies the q search for manufacturers
	 * 
	...
	public void main() throws JSONException, ParseException,
		...
		myUtils.standardTestDriver("createSearchManufacturers.json",
				UserTokensArray);
		...
		myUtils.standardTestDriver("searchManufacturers.json", UserTokensArray);
	...
	public void cleanup() throws JSONException, ParseException,
		...
		jsonObject = myUtils.getJson("searchManufacturers.json");
