...
/**
 * This is a basic smoke test for the Creation, Read, Update and Delete of Process Definitions
 * 
 */
public class crudProcessDefinitions extends SugarTestApi {
	...
	public void main() throws JSONException, ParseException,
		...
		myUtils.standardTestDriver("rest/base/crudProcessDefinitions.json", UserTokensArray);
	...
	public void cleanup() throws JSONException, ParseException,
		...
		jsonObject = myUtils.getJson("rest/base/crudProcessDefinitions.json");
