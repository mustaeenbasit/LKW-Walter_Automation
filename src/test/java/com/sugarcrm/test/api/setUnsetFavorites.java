...
public class setUnsetFavorites extends SugarTestApi {
	...
	@Test
	/**
	 * Test Case crudAccounts: Verifies the basic Create, Read, Update and Delete rest API calls
	 * for Accounts
	 * 
	...
	public void main() throws JSONException, ParseException,
		...
		myUtils.standardTestDriver("setUnsetFavorites.json", UserTokensArray);
	...
	public void cleanup() throws JSONException, ParseException,
		...
		jsonObject = myUtils.getJson("setUnsetFavorites.json");
