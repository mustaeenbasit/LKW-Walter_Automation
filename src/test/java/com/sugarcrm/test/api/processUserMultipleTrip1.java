...
/**
 * Verifies a round trip followed by a one way followed by an approve using 3
 * different users
 * 
 */
public class processUserMultipleTrip1 extends SugarTestApi {
	...
	public void main() throws JSONException, ParseException,
		...
		myUtils.standardTestDriver("rest/base/processUserMultipleTrip1.json",
				UserTokensArray, recordIDs);
	...
	public void cleanup() throws JSONException, ParseException,
		...
		jsonObject = myUtils.getJson("rest/base/processUserMultipleTrip1.json");
