...
/**
 * This is a test for Process create and execution, the Approval of a Static
 * User to an Account Creation event is verified, together with reassigning a
 * round trip process user
 * 
 */
public class processUserAssignRoundTrip extends SugarTestApi
{
         ...
         FileNotFoundException, IOException, ParseException
   {
      ...
      myUtils.standardTestDriver(
            "rest/base/common/processUserApproveSetUp.json", UserTokensArray,
            recordIDs);

      // Calls a standard loop to process the common json test driven format
      myUtils.standardTestDriver("rest/base/processUserAssignRoundTrip.json",
            UserTokensArray, recordIDs);
         ...
         FileNotFoundException, IOException
   {
      ...
      jsonObject = myUtils.getJson("rest/base/processUserAssignRoundTrip.json");
