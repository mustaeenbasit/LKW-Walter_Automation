...
/**
 * This test verifies that for a middle manager: When Forecasting is by
 * Opportunity and the Group Manager sets a Quota and the Middle manager
 * allocates more than the total Quota to his directs and himself, both the
 * original Quota and the over allocated Quota are visible to the Group manager
 * 
 */
public class forecastsQuotaOppAdjustedOver extends SugarTestApi {
	...
	public void setup() throws FileNotFoundException, IOException,
		...
		// Calls a common json to Configure Forecasts by Opportunity
