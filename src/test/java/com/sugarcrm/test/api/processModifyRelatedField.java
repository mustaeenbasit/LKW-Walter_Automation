 ...
 * 
 */
public class processModifyRelatedField extends SugarTestApi
{
         ...
         FileNotFoundException, IOException, ParseException
   {
      ...
      myUtils.standardTestDriver("rest/base/processModifyRelatedField.json",
         ...
         FileNotFoundException, IOException
   {
      ...
      jsonObject = myUtils
            .getJson("rest/base/processModifyRelatedField.json");
