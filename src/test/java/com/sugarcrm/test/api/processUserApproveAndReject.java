 ...
 * Static User to a multiple Account Creation event is verified
 * 
 */
public class processUserApproveAndReject extends SugarTestApi {
   ...
   public void setup() throws FileNotFoundException, IOException,
	...
	public void main() throws JSONException, ParseException,
		...
		myUtils.standardTestDriver(
				"rest/base/processUserApproveMultipleRecords.json",
				UserTokensArray, recordIDs);

		// Calls a standard loop to execute the Rejection of the second Account
		myUtils.standardTestDriver(
				"rest/base/processUserApproveAndReject.json", UserTokensArray,
				recordIDs);
   ...
   public void cleanup() throws JSONException, ParseException,
		...
		jsonObject = myUtils
				.getJson("rest/base/processUserApproveAndReject.json");
