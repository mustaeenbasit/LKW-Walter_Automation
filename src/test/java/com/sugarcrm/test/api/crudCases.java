...
/**
 * This is a basic smoke test for the Creation, Read, Update and Delete of Cases
 * 
 */
public class crudCases extends SugarTestApi {
	...
	public void main() throws JSONException, ParseException,
		...
		myUtils.standardTestDriver("rest/base/crudCases.json", UserTokensArray);
	...
	public void cleanup() throws JSONException, ParseException,
		...
		jsonObject = myUtils.getJson("rest/base/crudCases.json");
