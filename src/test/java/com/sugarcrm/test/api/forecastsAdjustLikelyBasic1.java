 ...
 * for a direct report and then DOES NOT commit the forecast the middle manager's manager (group manager) CANNOT see the adjusted
 * likely case for the forecast of the appropriate indirect report.
 * 
 */
public class forecastsAdjustLikelyBasic1 extends SugarTestApi {
   ...
   public void setup() throws FileNotFoundException, IOException,
	...
	public void main() throws JSONException, ParseException,
		...
		myUtils.standardTestDriver(
				"rest/base/forecastsAdjustLikelyBasic1.json", UserTokensArray,
				recordIDs);
   ...
   public void cleanup() throws JSONException, ParseException,
		...
		myUtils.deleteModules("rest/base/forecastsAdjustLikelyBasic1.json",
				UserTokensArray);
