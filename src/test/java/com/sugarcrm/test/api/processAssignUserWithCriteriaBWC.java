...
/**
 * This is a test for Process with criteria create and execution, the Assign of
 * a Static User to Contract is verified
 * 
 */
public class processAssignUserWithCriteriaBWC extends SugarTestApi {
	...
	public void main() throws JSONException, ParseException,
		...
		myUtils.standardTestDriver(
				"rest/base/processAssignUserWithCriteriaBWC.json",
				UserTokensArray, recordIDs);
	...
	public void cleanup() throws JSONException, ParseException,
		...
		jsonObject = myUtils
				.getJson("rest/base/processAssignUserWithCriteriaBWC.json");
