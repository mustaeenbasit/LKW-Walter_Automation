 ...
 * Static User to a Contracts Update event is verified with Read Only fields
 * 
 */
public class processApproveUpdateReadOnlyContracts extends SugarTestApi {
	...
	public void main() throws JSONException, ParseException,
		...
		myUtils.standardTestDriver(
				"rest/base/processApproveUpdateReadOnlyContracts.json",
				UserTokensArray, recordIDs);
	...
	public void cleanup() throws JSONException, ParseException,
		...
		jsonObject = myUtils
				.getJson("rest/base/processApproveUpdateReadOnlyContracts.json");
