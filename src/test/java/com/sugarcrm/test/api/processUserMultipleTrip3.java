...
/**
 * Verifies a round trip followed by a one way followed by another round trip
 * followed by an approve using 3 different users
 * 
 */
public class processUserMultipleTrip3 extends SugarTestApi {
	...
	oauthToken = myUtils.userLogin("rest/common/loginsalesRep2.json",
		UserTokensArray);
	// Login as Sales Mgr 1 to get the Authentication Token
	...
	myUtils.standardTestDriver("rest/base/processUserMultipleTrip3.json",
		UserTokensArray, recordIDs);
	...
	jsonObject = myUtils.getJson("rest/base/processUserMultipleTrip3.json");
