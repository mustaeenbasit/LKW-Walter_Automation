...
/**
 * Verifies a round trip followed by another round trip followed by an approve
 * 
 */
public class processUserMultipleTrip4 extends SugarTestApi {
	...
	myUtils.standardTestDriver("rest/base/processUserMultipleTrip4.json",
		UserTokensArray, recordIDs);
	...
	jsonObject = myUtils.getJson("rest/base/processUserMultipleTrip4.json");
