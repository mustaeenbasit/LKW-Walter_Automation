 ...
 * a Static User to Account is verified
 * 
 */
public class processAssignUserWithCriteria extends SugarTestApi {
	...
	public void main() throws JSONException, ParseException,
		...
		myUtils.standardTestDriver(
				"rest/base/processAssignUserWithCriteria.json",
				UserTokensArray, recordIDs);
	...
	public void cleanup() throws JSONException, ParseException,
		...
		jsonObject = myUtils
				.getJson("rest/base/processAssignUserWithCriteria.json");
