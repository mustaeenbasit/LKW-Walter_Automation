 ...
 * Static User to an Account Update event only once is verified
 * 
 */
public class processUserApproveUpdateOnceAccounts extends SugarTestApi {
	...
	public void main() throws JSONException, ParseException,
		...
		myUtils.standardTestDriver(
				"rest/base/processUserApproveUpdateOnceAccounts.json",
				UserTokensArray, recordIDs);
	...
	public void cleanup() throws JSONException, ParseException,
		...
		jsonObject = myUtils
				.getJson("rest/base/processUserApproveUpdateOnceAccounts.json");
