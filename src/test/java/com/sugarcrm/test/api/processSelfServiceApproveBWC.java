...
/**
 * This is a test for Process create and execution, the Self Service and
 * Approval of a User to an Account Creation event is verified
 * 
 */
public class processSelfServiceApproveBWC extends SugarTestApi {
	...
	@Test
	// @Ignore //Need way to use HTTP to invoke the Claim button
	public void main() throws JSONException, ParseException,
		...
		myUtils.standardTestDriver(
				"rest/base/processSelfServiceApproveBWC.json", UserTokensArray,
				recordIDs);
	...
	public void cleanup() throws JSONException, ParseException,
		...
		jsonObject = myUtils
				.getJson("rest/base/processSelfServiceApproveBWC.json");
