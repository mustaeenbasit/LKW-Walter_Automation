...
/**
 * This is a Role ACL test for Delete set to team when the record has selected to true for a BWC Module
 * 
 */
public class adminRoleDeleteTeamSelectedBWC extends SugarTestApi
{
   ...
   public void main() throws JSONException, ParseException, FileNotFoundException, IOException, ParseException
   {
      ...
      myUtils.standardTestDriver("rest/base/adminRoleDeleteTeamBWC.json",
      UserTokensArray, recordIDs);
      
      myUtils.standardTestDriver("rest/base/adminRoleDeleteTeamSelectedBWC.json",
            UserTokensArray, recordIDs);
   ...
   public void cleanup() throws JSONException, ParseException, FileNotFoundException, IOException
   {
      ...
      myUtils.deleteModules("rest/base/adminRoleDeleteTeamBWC.json",
      UserTokensArray);
