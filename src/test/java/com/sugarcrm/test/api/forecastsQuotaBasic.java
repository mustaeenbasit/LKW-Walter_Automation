...
/**
 * This test verifies that for a middle manager: When the Group Manager sets a
 * Quota and the Middle manager can view the Quota set
 * 
 */
public class forecastsQuotaBasic extends SugarTestApi {
	...
	public void cleanup() throws JSONException, ParseException,
		...
		myUtils.deleteModules("rest/base/forecastsQuotaBasic.json",
				UserTokensArray);
