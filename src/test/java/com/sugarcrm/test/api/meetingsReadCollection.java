...
/**
 * This test verifies the next offset values of the GET Meeting with Collection
 * of Invitees
 * 
 */
public class meetingsReadCollection extends SugarTestApi {
	...
	public void main() throws JSONException, ParseException,
		...
		myUtils.standardTestDriver("rest/base/meetingsReadCollection.json",
				UserTokensArray, recordIDs);
	...
	public void cleanup() throws JSONException, ParseException,
		...
		myUtils.deleteModules("rest/base/meetingsReadCollection.json",
				UserTokensArray);
	}
