 ...
 * the associated user. In addition the test verifies that if the User is then
 * un-related to the Role the User no longer has the Role Based Account Record
 * Layout set in their meta data
 * 
 */
public class adminModifyAndResetAccountRecordRBV extends SugarTestApi {
   ...
   public void setup() throws FileNotFoundException, IOException,
	...
	public void main() throws JSONException, ParseException,
		...
		// Remove the Role and User relationship and verify the RBV has been
		// removed for the User
		myUtils.standardTestDriver(
				"rest/base/adminModifyAndResetAccountRecordRBV.json",
				UserTokensArray, recordIDs);
