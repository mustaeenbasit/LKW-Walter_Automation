...
public class pat697ContactEmail extends SugarTestApi {
	...
	@Test
	/**
	 * Test Case pat697ContactEmail: Verifies issue Pat-697 Using email1 field in API call no longer attaches email to created record
	 * 
	...
	public void main() throws JSONException, ParseException,
		...
		myUtils.standardTestDriver("pat697ContactEmail.json", UserTokensArray);
	...
	public void cleanup() throws JSONException, ParseException,
		...
		jsonObject = myUtils.getJson("pat697ContactEmail.json");
