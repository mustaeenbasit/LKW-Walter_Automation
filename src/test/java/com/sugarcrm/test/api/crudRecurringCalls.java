...
/**
 * This is a basic smoke test for the Creation, Read, Update and Delete of Recurring Calls
 * 
 */
public class crudRecurringCalls extends SugarTestApi {
	...
	public void main() throws JSONException, ParseException,
		...
		myUtils.standardTestDriver("rest/base/crudRecurringCalls.json", UserTokensArray);
	...
	public void cleanup() throws JSONException, ParseException,
		...
		jsonObject = myUtils.getJson("rest/base/crudRecurringCalls.json");
