...
public class subscribeAccounts extends SugarTestApi {
	...
	@Test
	/**
	 * Test Case subscribeAccounts: Verifies that an Account can be followed using Subscribe
	 * 
	...
	public void main() throws JSONException, ParseException,
		...
		myUtils.standardTestDriver("subscribeAccounts.json", UserTokensArray);
	...
	public void cleanup() throws JSONException, ParseException,
		...
		jsonObject = myUtils.getJson("subscribeAccounts.json");
