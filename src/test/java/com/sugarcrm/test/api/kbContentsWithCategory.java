 ...
 * 
 */
public class kbContentsWithCategory extends SugarTestApi
{
         ...
         FileNotFoundException, IOException, ParseException
   {
      ...
      myUtils.standardTestDriver("rest/base/kbContentsWithCategory.json",
            UserTokensArray);
         ...
         FileNotFoundException, IOException
   {
      ...
      myUtils.deleteModules("rest/base/kbContentsWithCategory.json",
            UserTokensArray);
   }
