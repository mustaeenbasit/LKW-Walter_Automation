 ...
 * un-related to the Role the User no longer has the Role Based account_type_dom
 * set in their meta data
 * 
 */
public class adminModifyAndResetAccountTypeDomRB extends SugarTestApi {
   ...
   public void setup() throws FileNotFoundException, IOException,
	...
	public void main() throws JSONException, ParseException,
		...
		myUtils.standardTestDriver(
				"rest/base/adminModifyAndResetAccountTypeDomRB.json", UserTokensArray,
				recordIDs);
