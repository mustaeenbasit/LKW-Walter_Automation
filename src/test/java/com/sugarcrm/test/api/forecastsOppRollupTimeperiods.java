 ...
 * two directs enter RLIs for two time periods, those forecasts are correctly
 * rolled up for the manager to view in the appropriate time period
 * 
 */
public class forecastsOppRollupTimeperiods extends SugarTestApi {
	...
	public void cleanup() throws JSONException, ParseException,
		...
		myUtils.deleteModules("rest/base/forecastsOppRollupTimeperiods.json",
				UserTokensArray);
