...
/**
 * This is a test for Process create and execution, the Assign of a Static User
 * to Account is verified
 * 
 */
public class processAssignUser1 extends SugarTestApi {
	...
	public void main() throws JSONException, ParseException,
		...
		myUtils.standardTestDriver("rest/base/processAssignUser1.json",
				UserTokensArray, recordIDs);
	...
	public void cleanup() throws JSONException, ParseException,
		...
		jsonObject = myUtils.getJson("rest/base/processAssignUser1.json");
