 ...
 * Static User to an Account Creation event is verified
 * 
 */
public class processUserTeamApprove1 extends SugarTestApi {
   ...
   public void setup() throws FileNotFoundException, IOException,
	...
	public void main() throws JSONException, ParseException,
		...
		myUtils.standardTestDriver("rest/base/processUserTeamApprove1.json",
				UserTokensArray, recordIDs);
   ...
   public void cleanup() throws JSONException, ParseException,
		...
		jsonObject = myUtils.getJson("rest/base/processUserTeamApprove1.json");
