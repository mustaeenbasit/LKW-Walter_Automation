...
/**
 * This is a basic smoke test for the Creation, Read, Update and Delete of Bugs
 * 
 */
public class crudBugs extends SugarTestApi {
	...
	public void main() throws JSONException, ParseException,
		...
		myUtils.standardTestDriver("rest/base/crudBugs.json", UserTokensArray);
	...
	public void cleanup() throws JSONException, ParseException,
		...
		jsonObject = myUtils.getJson("rest/base/crudBugs.json");
