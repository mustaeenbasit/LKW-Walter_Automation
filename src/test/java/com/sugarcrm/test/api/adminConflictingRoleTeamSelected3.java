...
/**
 * This is a Role ACL conflicting test for field level and team based ACL at module level
 * 
 */
public class adminConflictingRoleTeamSelected3 extends SugarTestApi
{
   ...
   // Delete the Custom Standard Role created during this test
      ...
      UserTokensArray, recordIDs);
   // Delete the second Custom Standard Role created during this test
