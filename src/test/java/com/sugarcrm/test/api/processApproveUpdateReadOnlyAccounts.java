 ...
 * Static User to an Account Update event is verified with Read Only fields
 * 
 */
public class processApproveUpdateReadOnlyAccounts extends SugarTestApi {
	...
	public void main() throws JSONException, ParseException,
		...
		myUtils.standardTestDriver(
				"rest/base/processApproveUpdateReadOnlyAccounts.json",
				UserTokensArray, recordIDs);
	...
	public void cleanup() throws JSONException, ParseException,
		...
		jsonObject = myUtils
				.getJson("rest/base/processApproveUpdateReadOnlyAccounts.json");
