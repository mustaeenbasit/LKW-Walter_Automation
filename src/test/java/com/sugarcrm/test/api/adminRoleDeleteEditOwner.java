...
/**
 * This is a Role ACL test for Delete and Edit set to Owner
 * 
 */
public class adminRoleDeleteEditOwner extends SugarTestApi {
   ...
   public void setup() throws FileNotFoundException, IOException,
	...
	// Calls a standard loop to set up RLI with Opportunities
      myUtils.standardTestDriver("rest/common/opportunitiesRLIConfig.json",
		...
		// Calls a Lib to create Role with access defined in the passed json
		// file
		myRolesModule.CreateRole(adminUserID,
				"rest/base/adminRoleDeleteEditOwnerSetUp.json");
	...
	public void main() throws JSONException, ParseException,
		...
		myUtils.standardTestDriver("rest/base/adminRoleDeleteEditOwner.json",
				UserTokensArray, recordIDs);
   ...
   public void cleanup() throws JSONException, ParseException,
		...
		myUtils.deleteModules("rest/base/adminRoleDeleteEditOwner.json",
				UserTokensArray);
