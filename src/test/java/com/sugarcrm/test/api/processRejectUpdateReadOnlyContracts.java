...
/**
 * This is a test for Process create and execution, the Assign and Rejection of
 * a Static User to a Contracts Update event is verified with Read Only fields
 * 
 */
public class processRejectUpdateReadOnlyContracts extends SugarTestApi {
	...
	public void main() throws JSONException, ParseException,
		...
		myUtils.standardTestDriver(
				"rest/base/processRejectUpdateReadOnlyContracts.json",
				UserTokensArray, recordIDs);
	...
	public void cleanup() throws JSONException, ParseException,
		...
		jsonObject = myUtils
				.getJson("rest/base/processRejectUpdateReadOnlyContracts.json");
