 ...
 * Static User to a Contract Creation event is verified
 * 
 */
public class processUserApproveContracts extends SugarTestApi {
	...
	public void main() throws JSONException, ParseException,
		...
		// reject during Contracts Creation
		...
		myUtils.standardTestDriver(
				"rest/base/processUserApproveContracts.json", UserTokensArray,
				recordIDs);
	...
	public void cleanup() throws JSONException, ParseException,
		...
		jsonObject = myUtils
				.getJson("rest/base/processUserApproveContracts.json");
