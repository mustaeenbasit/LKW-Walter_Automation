...
/**
 * This test verifies that for a recursive reporting structure cannot be created
 * for Users
 * 
 */
public class usersReportLoop extends SugarTestApi {
   ...
   public void setup() throws FileNotFoundException, IOException,
		...
		// Create group of users with no reporting loop
	...
	public void main() throws JSONException, ParseException,
		...
		// Update a User to try and include a reporting loop
		myUtils.standardTestDriver("rest/common/usersReportLoop.json",
				UserTokensArray, recordIDs);
