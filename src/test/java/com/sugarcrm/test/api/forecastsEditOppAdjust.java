...
/**
 * This test verifies that for a direct report: When the likely forecast, by
 * Opportunity, amount is adjusted by the manager then if the Opportunity likely
 * amount is subsequently changed by the direct report, the adjusted amount is
 * NOT updated
 * 
 */
public class forecastsEditOppAdjust extends SugarTestApi {
	...
	public void main() throws JSONException, ParseException,
		...
		myUtils.standardTestDriver("rest/base/forecastsEditOppAdjust.json",
				UserTokensArray, recordIDs);
	...
	public void cleanup() throws JSONException, ParseException,
		...
		myUtils.deleteModules("rest/base/forecastsEditOppAdjust.json",
				UserTokensArray);
