 ...
 * Opportunity amount is adjusted by the middle manager him self then if the
 * Opportunity likely amount is changed by the middle manager, the adjusted
 * amount is NOT updated automatically to match
 * 
 */
public class forecastsEditOppAdjustMgr extends SugarTestApi {
	...
	public void setup() throws FileNotFoundException, IOException,
		...
		myUtils.standardTestDriver(
				...
				UserTokensArray);
		// Calls a common json to Configure Forecasts
	...
	@Test
	/**
	 * Test Case forecastsEditOppAdjust: For middle MGR - Verify when the likely forecast by Opportunity amount is adjusted
	 *  if the Opp likely amount is changed, the adjusted amount is NOT updated automatically to match
	...
	public void main() throws JSONException, ParseException,
		...
		myUtils.standardTestDriver("rest/base/forecastsEditOppAdjustMgr.json",
				UserTokensArray, recordIDs);
	...
	public void cleanup() throws JSONException, ParseException,
		...
		myUtils.deleteModules("rest/base/forecastsEditOppAdjustMgr.json",
				UserTokensArray);
