...
/**
 * This is a test for Process create and execution, the Assign and Approval of a
 * Static User to a multiple Contracts - BWC - Creation event is verified
 * 
 */
public class processUserApproveAndRejectBWC extends SugarTestApi {
   ...
   public void setup() throws FileNotFoundException, IOException,
	...
	public void main() throws JSONException, ParseException,
		...
		myUtils.standardTestDriver(
				"rest/base/common/processUserApproveSetUpContracts.json",
				UserTokensArray, recordIDs);

		// Pause for 4 seconds so the modified date seconds are different
		Thread.sleep(4000);

		// Calls a standard loop to execute the approval of the first Account
		myUtils.standardTestDriver(
				"rest/base/processUserApproveMultipleRecordsBWC.json",
				UserTokensArray, recordIDs);

		// Pause for 4 seconds so the modified date seconds are different
		Thread.sleep(4000);

		// Calls a standard loop to execute the Rejection of the second Account
		myUtils.standardTestDriver(
				"rest/base/processUserApproveAndRejectBWC.json",
				UserTokensArray, recordIDs);
   ...
   public void cleanup() throws JSONException, ParseException,
		...
		jsonObject = myUtils
				.getJson("rest/base/processUserApproveAndRejectBWC.json");
