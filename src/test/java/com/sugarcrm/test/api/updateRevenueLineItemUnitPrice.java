...
public class updateRevenueLineItemUnitPrice extends SugarTestApi {
	...
	@Test
	/**
	 * Test Case updateRevenueLineItem Unit Price: Verifies the values of RLI Unit Price
	 * 
	...
	public void main() throws JSONException, ParseException,
		...
		myUtils.standardTestDriver("updateRevenueLineItemUnitPrice.json",
				UserTokensArray);
	...
	public void cleanup() throws JSONException, ParseException,
		...
		jsonObject = myUtils.getJson("updateRevenueLineItemUnitPrice.json");
