 ...
 * non-ative by making it published then delete the active and verify the new
 * active
 * 
 */
public class KBContentsRevisionPublishDelete extends SugarTestApi
{
         ...
         FileNotFoundException, IOException, ParseException
   {
      ...
      myUtils.standardTestDriver(
            "rest/base/kbContentsRevisionPublishDelete.json", UserTokensArray);
         ...
         FileNotFoundException, IOException
   {
      ...
      myUtils.deleteModules("rest/base/kbContentsRevisionPublishDelete.json",
            UserTokensArray);
   }
