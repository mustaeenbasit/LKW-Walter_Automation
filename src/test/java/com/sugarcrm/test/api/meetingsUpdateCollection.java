...
/**
 * This test verifies the Update of a Meeting that uses the Collections api
 * format to include adding and deleting of related Contacts, Users and Leads
 * 
 */
public class meetingsUpdateCollection extends SugarTestApi {
	...
	public void main() throws JSONException, ParseException,
		...
		myUtils.standardTestDriver("rest/base/meetingsCreateCollection.json",
				UserTokensArray, recordIDs);
		// Calls a standard loop to process the json Test for Update Collections
		// API
		myUtils.standardTestDriver("rest/base/meetingsUpdateCollection.json",
				UserTokensArray, recordIDs);
	...
	public void cleanup() throws JSONException, ParseException,
		...
		myUtils.deleteModules("rest/base/meetingsUpdateCollection.json",
				UserTokensArray);
	}
