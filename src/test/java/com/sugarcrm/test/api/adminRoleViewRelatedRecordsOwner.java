...
/**
 * This is a Role ACL test for not allowing view a related record if only the
 * owner can view records
 * 
 */
public class adminRoleViewRelatedRecordsOwner extends SugarTestApi {
   ...
   public void setup() throws FileNotFoundException, IOException,
		...
		myRolesModule.CreateRole(adminUserID,
				"rest/base/adminRoleViewRelatedRecordsOwnerSetUp.json");
	...
	public void main() throws JSONException, ParseException,
		...
		myUtils.standardTestDriver(
				"rest/base/adminRoleViewRelatedRecordsOwner.json",
				UserTokensArray, recordIDs);
