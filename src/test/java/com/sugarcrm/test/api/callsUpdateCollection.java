...
/**
 * This test verifies the Update of a Call that uses the Collections api
 * format to include adding and deleting of related Contacts, Users and Leads
 * 
 */
public class callsUpdateCollection extends SugarTestApi {
	...
	public void main() throws JSONException, ParseException,
		...
		// API
		myUtils.standardTestDriver("rest/base/callsUpdateCollection.json",
				UserTokensArray, recordIDs);
	...
	public void cleanup() throws JSONException, ParseException,
		...
		myUtils.deleteModules("rest/base/callsUpdateCollection.json",
				UserTokensArray);
	}
