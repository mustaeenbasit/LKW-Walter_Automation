 ...
 * two of his directs enter RLIs for two different Time Periods, the RLI amounts
 * are visible to the middle manager, in the appropriate Time Period, if the
 * RLIs are set to 'include' and the direct report has committed his forecast
 * 
 */
public class forecastsRollupTimeperiods extends SugarTestApi {
   ...
   public void setup() throws FileNotFoundException, IOException,
	...
	public void main() throws JSONException, ParseException,
		...
		myUtils.standardTestDriver("rest/base/forecastsRollupTimeperiods.json",
				UserTokensArray, recordIDs);
   ...
   public void cleanup() throws JSONException, ParseException,
		...
		myUtils.deleteModules("rest/base/forecastsRollupTimeperiods.json",
				UserTokensArray);
