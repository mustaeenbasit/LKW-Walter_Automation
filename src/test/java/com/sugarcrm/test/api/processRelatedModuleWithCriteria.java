...
/**
 * This is a test for Process with criteria that is for a related module, the
 * action sets a field in the Target Module
 * 
 */
public class processRelatedModuleWithCriteria extends SugarTestApi
{
         ...
         FileNotFoundException, IOException, ParseException
   {
      ...
      myUtils.standardTestDriver(
            "rest/base/processRelatedModuleWithCriteria.json", UserTokensArray,
            recordIDs);
         ...
         FileNotFoundException, IOException
   {
      ...
      jsonObject = myUtils
            .getJson("rest/base/processRelatedModuleWithCriteria.json");
