 ...
 * 
 */
public class crudKBContentsRevision extends SugarTestApi
{
         ...
         FileNotFoundException, IOException, ParseException
   {
      ...
      myUtils.standardTestDriver("rest/base/crudKBContentsRevision.json",
            UserTokensArray);
         ...
         FileNotFoundException, IOException
   {
      ...
      myUtils.deleteModules("rest/base/crudKBContentsRevision.json",
            UserTokensArray);
