...
/**
 * This is a test for Process Definition import for a Gateway PD
 * 
 */
public class processImportMultipleCreateRelated extends SugarTestApi
{
         ...
         FileNotFoundException, IOException, ParseException
   {
      ...
      myUtils.standardTestDriver(
            "rest/base/processImportMultipleCreatedRelated.json",
         ...
         FileNotFoundException, IOException
   {
      ...
      jsonObject = myUtils
            .getJson("rest/base/processImportMultipleCreatedRelated.json");
