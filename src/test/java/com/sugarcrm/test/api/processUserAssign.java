 ...
 * User to an Account Creation event is verified, together with the approving
 * user assigning another user to the record
 * 
 */
public class processUserAssign extends SugarTestApi {
	...
	public void main() throws JSONException, ParseException,
		...
		myUtils.standardTestDriver("rest/base/processUserAssign.json",
				UserTokensArray, recordIDs);
	...
	public void cleanup() throws JSONException, ParseException,
		...
		jsonObject = myUtils.getJson("rest/base/processUserAssign.json");
