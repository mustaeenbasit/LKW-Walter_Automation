...
public class Dashlets_20293_Leads extends SugarTest {
	...
	public void setup() throws Exception {
		...
		// Link the created Tasks to the created leads
	...
	private void addActiveTasksDashlet(int row, int column, String dashletName) throws Exception {
		...
		sugar.leads.dashboard.addDashlet(row, column);
		...
		// Save
		new VoodooControl("a", "css", ".layout_Leads.drawer.active .fld_save_button a").click();
	...
	/**
	 * Verify tasks dashlets should be available on record view of leads
	 * 
	 * @throws Exception
	 */
	@Test
	public void Dashlets_20293_Leads_execute() throws Exception {
		...
		dashboardTitle = sugar.leads.dashboard.getControl("dashboardTitle");
		...
		// Verify that both Active Tasks and Inactive Tasks dashlets should be available to be used on record view of leads
