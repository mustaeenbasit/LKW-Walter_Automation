...
public class Dashlets_20293_Accounts extends SugarTest {
	...
	public void setup() throws Exception {
		...
		// Link the created Tasks to the created Accounts
		sugar.accounts.navToListView();
		sugar.accounts.listView.clickRecord(1);
		VoodooUtils.waitForReady(); //Extra wait needed
		StandardSubpanel tasksSubpanel = sugar.accounts.recordView.subpanels.get(sugar.tasks.moduleNamePlural);
	...
	/**
	 * Verify tasks dashlets should be available on record view of Accounts
	 * 
	 * @throws Exception
	 */
	@Test
	public void Dashlets_20293_Accounts_execute() throws Exception {
		...
		// TODO: VOOD-960
		VoodooControl activeTaskDashletCtrl = new VoodooControl("li", "css", ".row-fluid.sortable:nth-of-type(6) .dashlet-container:nth-of-type(1)");
		VoodooControl inactiveTaskDashletCtrl = new VoodooControl("li", "css", ".row-fluid.sortable:nth-of-type(7) .dashlet-container:nth-of-type(1)");

		// Verify that both Active Tasks and Inactive Tasks dashlets should be available to be used on record view of Accounts
