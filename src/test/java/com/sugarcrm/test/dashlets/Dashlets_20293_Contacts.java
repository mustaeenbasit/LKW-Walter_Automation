...
public class Dashlets_20293_Contacts extends SugarTest {
	...
	public void setup() throws Exception {
		...
		// Link the created Tasks to the created contacts
	...
	private void addActiveTasksDashlet(int row, int column, String dashletName) throws Exception {
		...
		sugar.contacts.dashboard.addDashlet(row, column);
		...
		// Save
		new VoodooControl("a", "css", ".layout_Contacts.drawer.active .fld_save_button a").click();
	...
	/**
	 * Verify tasks dashlets should be available on record view of Contacts
	 * 
	 * @throws Exception
	 */
	@Test
	public void Dashlets_20293_Contacts_execute() throws Exception {
		...
		dashboardTitle = sugar.contacts.dashboard.getControl("dashboardTitle");
		...
		addActiveTasksDashlet(3, 1, dashboardData.get("activeTasks"));
		addActiveTasksDashlet(4, 1, dashboardData.get("inactiveTasks"));

		// TODO: VOOD-960
		VoodooControl activeTaskDashletCtrl = new VoodooControl("li", "css", ".row-fluid.sortable:nth-of-type(3) .dashlet-container:nth-of-type(1)");
		VoodooControl inactiveTaskDashletCtrl = new VoodooControl("li", "css", ".row-fluid.sortable:nth-of-type(4) .dashlet-container:nth-of-type(1)");

		// Verify that both Active Tasks and Inactive Tasks dashlets should be available to be used on record view of contacts
