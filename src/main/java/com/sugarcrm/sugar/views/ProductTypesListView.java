...
/**
 * Models the ListView for ProductTypes. This class overrides the methods of base class 
 * @author Mohd. Shariq <mshariq@sugarcrm.com>
 *
 */
public class ProductTypesListView extends BWCListView {
	 ...
	 */
	public ProductTypesListView(RecordsModule parentModule) throws Exception {
		super(parentModule);
